...
<h3 align="center">A Computer Science student at Carleton University focused on AI/ML, Cybersecurity & Infrastructure and a Minor in Business</h3>


---
<h3 align="left">🌟 About Me:</h3>
<ul>
    <li>🤖 Focused on <strong>AI and ML</strong>, building LLM-powered systems, intelligent agents, and automation pipelines, with an emphasis on real-world applications and scalable system design.</li>
    <li>🔒 Passionate about <strong>Cyber AI and secure system design</strong>, exploring threat detection, anomaly detection, adversarial attacks (e.g., jailbreaks and prompt injection), and how AI can enhance cybersecurity and system resilience.</li>
